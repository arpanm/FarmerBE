...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELDVISIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIELDVISIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIELDVISIT actions', async () => {
      const arg = { id: 22225 };
    ...
    it('dispatches UPDATE_FIELDVISIT actions', async () => {
      const arg = { id: 22225 };
    ...
    it('dispatches PARTIAL_UPDATE_FIELDVISIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIELDVISIT actions', async () => {
      const arg = 42666;
