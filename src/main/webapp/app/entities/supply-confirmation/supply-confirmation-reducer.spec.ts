...
import reducer, {
  ...
  reset,
  updateEntity,
} from './supply-confirmation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLYCONFIRMATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPLYCONFIRMATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPLYCONFIRMATION actions', async () => {
      const arg = { id: 25043 };
    ...
    it('dispatches UPDATE_SUPPLYCONFIRMATION actions', async () => {
      const arg = { id: 25043 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLYCONFIRMATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPLYCONFIRMATION actions', async () => {
      const arg = 42666;
