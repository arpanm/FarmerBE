...
import reducer, {
  ...
  reset,
  updateEntity,
} from './buyer-target-achivement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUYERTARGETACHIVEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUYERTARGETACHIVEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUYERTARGETACHIVEMENT actions', async () => {
      const arg = { id: 5413 };
    ...
    it('dispatches UPDATE_BUYERTARGETACHIVEMENT actions', async () => {
      const arg = { id: 5413 };
    ...
    it('dispatches PARTIAL_UPDATE_BUYERTARGETACHIVEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BUYERTARGETACHIVEMENT actions', async () => {
      const arg = 42666;
