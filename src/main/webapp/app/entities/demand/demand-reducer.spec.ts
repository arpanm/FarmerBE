...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './demand.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEMAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEMAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEMAND actions', async () => {
      const arg = { id: 29824 };
    ...
    it('dispatches UPDATE_DEMAND actions', async () => {
      const arg = { id: 29824 };
    ...
    it('dispatches PARTIAL_UPDATE_DEMAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEMAND actions', async () => {
      const arg = 42666;
