...
import { deleteEntity, getEntity } from './demand.reducer';

export const DemandDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(demandEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="farmerBeApp.demand.delete.question">
        <Translate contentKey="farmerBeApp.demand.delete.question" interpolate={{ id: demandEntity.id }}>
...
export default DemandDeleteDialog;
