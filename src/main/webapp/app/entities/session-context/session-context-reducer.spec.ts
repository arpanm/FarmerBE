...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SESSIONCONTEXT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SESSIONCONTEXT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SESSIONCONTEXT actions', async () => {
      const arg = { id: 10444 };
    ...
    it('dispatches UPDATE_SESSIONCONTEXT actions', async () => {
      const arg = { id: 10444 };
    ...
    it('dispatches PARTIAL_UPDATE_SESSIONCONTEXT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SESSIONCONTEXT actions', async () => {
      const arg = 42666;
