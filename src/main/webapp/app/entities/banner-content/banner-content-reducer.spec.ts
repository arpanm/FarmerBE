...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANNERCONTENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANNERCONTENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANNERCONTENT actions', async () => {
      const arg = { id: 7310 };
    ...
    it('dispatches UPDATE_BANNERCONTENT actions', async () => {
      const arg = { id: 7310 };
    ...
    it('dispatches PARTIAL_UPDATE_BANNERCONTENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANNERCONTENT actions', async () => {
      const arg = 42666;
