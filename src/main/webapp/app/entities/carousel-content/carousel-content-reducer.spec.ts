...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAROUSELCONTENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CAROUSELCONTENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CAROUSELCONTENT actions', async () => {
      const arg = { id: 24986 };
    ...
    it('dispatches UPDATE_CAROUSELCONTENT actions', async () => {
      const arg = { id: 24986 };
    ...
    it('dispatches PARTIAL_UPDATE_CAROUSELCONTENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CAROUSELCONTENT actions', async () => {
      const arg = 42666;
