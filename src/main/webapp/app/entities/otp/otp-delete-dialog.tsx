...
import { deleteEntity, getEntity } from './otp.reducer';
...
export const OtpDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="farmerBeApp.otp.delete.question">
        <Translate contentKey="farmerBeApp.otp.delete.question" interpolate={{ id: otpEntity.id }}>
