...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PICKUPGRADATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PICKUPGRADATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PICKUPGRADATION actions', async () => {
      const arg = { id: 21444 };
    ...
    it('dispatches UPDATE_PICKUPGRADATION actions', async () => {
      const arg = { id: 21444 };
    ...
    it('dispatches PARTIAL_UPDATE_PICKUPGRADATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PICKUPGRADATION actions', async () => {
      const arg = 42666;
