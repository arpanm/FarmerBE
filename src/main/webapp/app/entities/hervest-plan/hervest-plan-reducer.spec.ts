...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HERVESTPLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HERVESTPLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HERVESTPLAN actions', async () => {
      const arg = { id: 23803 };
    ...
    it('dispatches UPDATE_HERVESTPLAN actions', async () => {
      const arg = { id: 23803 };
    ...
    it('dispatches PARTIAL_UPDATE_HERVESTPLAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HERVESTPLAN actions', async () => {
      const arg = 42666;
