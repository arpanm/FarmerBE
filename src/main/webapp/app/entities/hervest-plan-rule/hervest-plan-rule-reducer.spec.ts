...
import reducer, {
  ...
  reset,
  updateEntity,
} from './hervest-plan-rule.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HERVESTPLANRULE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HERVESTPLANRULE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HERVESTPLANRULE actions', async () => {
      const arg = { id: 3116 };
    ...
    it('dispatches UPDATE_HERVESTPLANRULE actions', async () => {
      const arg = { id: 3116 };
    ...
    it('dispatches PARTIAL_UPDATE_HERVESTPLANRULE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HERVESTPLANRULE actions', async () => {
      const arg = 42666;
