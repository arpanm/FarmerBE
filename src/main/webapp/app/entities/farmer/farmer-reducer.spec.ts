...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './farmer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FARMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FARMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FARMER actions', async () => {
      const arg = { id: 29614 };
    ...
    it('dispatches UPDATE_FARMER actions', async () => {
      const arg = { id: 29614 };
    ...
    it('dispatches PARTIAL_UPDATE_FARMER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FARMER actions', async () => {
      const arg = 42666;
