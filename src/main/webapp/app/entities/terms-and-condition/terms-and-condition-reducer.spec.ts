...
import reducer, {
  ...
  reset,
  updateEntity,
} from './terms-and-condition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERMSANDCONDITION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TERMSANDCONDITION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TERMSANDCONDITION actions', async () => {
      const arg = { id: 14001 };
    ...
    it('dispatches UPDATE_TERMSANDCONDITION actions', async () => {
      const arg = { id: 14001 };
    ...
    it('dispatches PARTIAL_UPDATE_TERMSANDCONDITION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TERMSANDCONDITION actions', async () => {
      const arg = 42666;
