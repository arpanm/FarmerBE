...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PANDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PANDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PANDETAILS actions', async () => {
      const arg = { id: 13663 };
    ...
    it('dispatches UPDATE_PANDETAILS actions', async () => {
      const arg = { id: 13663 };
    ...
    it('dispatches PARTIAL_UPDATE_PANDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PANDETAILS actions', async () => {
      const arg = 42666;
