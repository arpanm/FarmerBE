...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './farm.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FARM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FARM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FARM actions', async () => {
      const arg = { id: 25068 };
    ...
    it('dispatches UPDATE_FARM actions', async () => {
      const arg = { id: 25068 };
    ...
    it('dispatches PARTIAL_UPDATE_FARM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FARM actions', async () => {
      const arg = 42666;
