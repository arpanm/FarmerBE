...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEMANDDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEMANDDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEMANDDATA actions', async () => {
      const arg = { id: 24548 };
    ...
    it('dispatches UPDATE_DEMANDDATA actions', async () => {
      const arg = { id: 24548 };
    ...
    it('dispatches PARTIAL_UPDATE_DEMANDDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEMANDDATA actions', async () => {
      const arg = 42666;
