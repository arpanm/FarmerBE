...
import reducer, {
  ...
  reset,
  updateEntity,
} from './pick-up-confirmation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PICKUPCONFIRMATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PICKUPCONFIRMATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PICKUPCONFIRMATION actions', async () => {
      const arg = { id: 14099 };
    ...
    it('dispatches UPDATE_PICKUPCONFIRMATION actions', async () => {
      const arg = { id: 14099 };
    ...
    it('dispatches PARTIAL_UPDATE_PICKUPCONFIRMATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PICKUPCONFIRMATION actions', async () => {
      const arg = 42666;
