...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PICKUPPAYMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PICKUPPAYMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PICKUPPAYMENT actions', async () => {
      const arg = { id: 31650 };
    ...
    it('dispatches UPDATE_PICKUPPAYMENT actions', async () => {
      const arg = { id: 31650 };
    ...
    it('dispatches PARTIAL_UPDATE_PICKUPPAYMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PICKUPPAYMENT actions', async () => {
      const arg = 42666;
