...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './buyer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUYER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUYER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUYER actions', async () => {
      const arg = { id: 12413 };
    ...
    it('dispatches UPDATE_BUYER actions', async () => {
      const arg = { id: 12413 };
    ...
    it('dispatches PARTIAL_UPDATE_BUYER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BUYER actions', async () => {
      const arg = 42666;
