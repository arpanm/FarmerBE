...
import { deleteEntity, getEntity } from './buyer.reducer';

export const BuyerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="farmerBeApp.buyer.delete.question">
        <Translate contentKey="farmerBeApp.buyer.delete.question" interpolate={{ id: buyerEntity.id }}>
