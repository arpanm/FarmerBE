...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './crop.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CROP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CROP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CROP actions', async () => {
      const arg = { id: 18428 };
    ...
    it('dispatches UPDATE_CROP actions', async () => {
      const arg = { id: 18428 };
    ...
    it('dispatches PARTIAL_UPDATE_CROP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CROP actions', async () => {
      const arg = 42666;
