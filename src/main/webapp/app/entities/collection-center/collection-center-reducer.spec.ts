...
import reducer, {
  ...
  reset,
  updateEntity,
} from './collection-center.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTIONCENTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COLLECTIONCENTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COLLECTIONCENTER actions', async () => {
      const arg = { id: 15727 };
    ...
    it('dispatches UPDATE_COLLECTIONCENTER actions', async () => {
      const arg = { id: 15727 };
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTIONCENTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COLLECTIONCENTER actions', async () => {
      const arg = 42666;
