...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEMANDDATAFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEMANDDATAFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEMANDDATAFILE actions', async () => {
      const arg = { id: 15593 };
    ...
    it('dispatches UPDATE_DEMANDDATAFILE actions', async () => {
      const arg = { id: 15593 };
    ...
    it('dispatches PARTIAL_UPDATE_DEMANDDATAFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEMANDDATAFILE actions', async () => {
      const arg = 42666;
