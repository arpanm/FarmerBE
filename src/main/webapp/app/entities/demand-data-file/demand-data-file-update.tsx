...
export const DemandDataFileUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    values.uploadedTime = convertDateTimeToServer(values.uploadedTime);
  ...
  const defaultValues = () =>
    isNew
      ? {
          uploadedTime: displayDefaultDateTime(),
      ...
      : {
          status: 'Init',
          ...demandDataFileEntity,
          uploadedTime: convertDateTimeFromServer(demandDataFileEntity.uploadedTime),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('farmerBeApp.demandDataFile.uploadedTime')}
                id="demand-data-file-uploadedTime"
                name="uploadedTime"
                data-cy="uploadedTime"
                type="datetime-local"
