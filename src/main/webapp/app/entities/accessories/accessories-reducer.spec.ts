...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCESSORIES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACCESSORIES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACCESSORIES actions', async () => {
      const arg = { id: 30746 };
    ...
    it('dispatches UPDATE_ACCESSORIES actions', async () => {
      const arg = { id: 30746 };
    ...
    it('dispatches PARTIAL_UPDATE_ACCESSORIES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACCESSORIES actions', async () => {
      const arg = 42666;
