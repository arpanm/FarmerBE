...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTENDENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ATTENDENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ATTENDENCE actions', async () => {
      const arg = { id: 15313 };
    ...
    it('dispatches UPDATE_ATTENDENCE actions', async () => {
      const arg = { id: 15313 };
    ...
    it('dispatches PARTIAL_UPDATE_ATTENDENCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ATTENDENCE actions', async () => {
      const arg = 42666;
