...
/**
 * REST controller for managing {@link com.farmer.be.domain.Farm}.
 */
@RestController
...
public class FarmResource {
    ...
    public ResponseEntity<FarmDTO> createFarm(@Valid @RequestBody FarmDTO farmDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/farms/" + farmDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, farmDTO.getId().toString()))
            .body(farmDTO);
    }
    ...
    public ResponseEntity<FarmDTO> updateFarm(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, farmDTO.getId().toString()))
            .body(farmDTO);
    }
    ...
    public ResponseEntity<FarmDTO> partialUpdateFarm(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, farmDTO.getId().toString())
        );
    }
