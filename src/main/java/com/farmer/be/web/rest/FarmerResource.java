...
/**
 * REST controller for managing {@link com.farmer.be.domain.Farmer}.
 */
@RestController
...
public class FarmerResource {
    ...
    public ResponseEntity<FarmerDTO> createFarmer(@Valid @RequestBody FarmerDTO farmerDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/farmers/" + farmerDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, farmerDTO.getId().toString()))
            .body(farmerDTO);
    }
    ...
    public ResponseEntity<FarmerDTO> updateFarmer(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, farmerDTO.getId().toString()))
            .body(farmerDTO);
    }
    ...
    public ResponseEntity<FarmerDTO> partialUpdateFarmer(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, farmerDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<FarmerDTO>> getAllFarmers(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
