...
public class CollectionCenter implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "collectionCenter")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "file", "collectionCenter" }, allowSetters = true)
    ...
    public void setDemandData(Set<DemandData> demandData) {
        if (this.demandData != null) {
            this.demandData.forEach(i -> i.setCollectionCenter(null));
        }
        if (demandData != null) {
            demandData.forEach(i -> i.setCollectionCenter(this));
        }
        this.demandData = demandData;
    }

    public CollectionCenter demandData(Set<DemandData> demandData) {
        this.setDemandData(demandData);
        return this;
    }

    public CollectionCenter addDemandData(DemandData demandData) {
        this.demandData.add(demandData);
        demandData.setCollectionCenter(this);
        return this;
    }

    public CollectionCenter removeDemandData(DemandData demandData) {
        this.demandData.remove(demandData);
        demandData.setCollectionCenter(null);
        return this;
    }
    ...
    public void setFarms(Set<Farm> farms) {
        if (this.farms != null) {
            this.farms.forEach(i -> i.setCollectionCenter(null));
        }
        if (farms != null) {
            farms.forEach(i -> i.setCollectionCenter(this));
        }
        this.farms = farms;
    }

    public CollectionCenter farms(Set<Farm> farms) {
        this.setFarms(farms);
        return this;
    }

    public CollectionCenter addFarm(Farm farm) {
        this.farms.add(farm);
        farm.setCollectionCenter(this);
        return this;
    }

    public CollectionCenter removeFarm(Farm farm) {
        this.farms.remove(farm);
        farm.setCollectionCenter(null);
        return this;
    }
    ...
    public void setBuyers(Set<Buyer> buyers) {
        if (this.buyers != null) {
            this.buyers.forEach(i -> i.setCollectionCenter(null));
        }
        if (buyers != null) {
            buyers.forEach(i -> i.setCollectionCenter(this));
        }
        this.buyers = buyers;
    }

    public CollectionCenter buyers(Set<Buyer> buyers) {
        this.setBuyers(buyers);
        return this;
    }

    public CollectionCenter addBuyer(Buyer buyer) {
        this.buyers.add(buyer);
        buyer.setCollectionCenter(this);
        return this;
    }

    public CollectionCenter removeBuyer(Buyer buyer) {
        this.buyers.remove(buyer);
        buyer.setCollectionCenter(null);
        return this;
    }
