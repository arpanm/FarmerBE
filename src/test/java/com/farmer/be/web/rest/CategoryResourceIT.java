...
import com.farmer.be.repository.CategoryRepository;
import com.farmer.be.service.dto.CategoryDTO;
import com.farmer.be.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.imagePath(UPDATED_IMAGE_PATH).createddBy(UPDATED_CREATEDD_BY).updatedTime(UPDATED_UPDATED_TIME);
