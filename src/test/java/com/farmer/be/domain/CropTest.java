...
class CropTest {
    ...
    void demandDataTest() {
        ...
        crop.setDemandData(demandDataBack);
        assertThat(crop.getDemandData()).isEqualTo(demandDataBack);
        assertThat(demandDataBack.getCrop()).isEqualTo(crop);

        crop.demandData(null);
        assertThat(crop.getDemandData()).isNull();
        assertThat(demandDataBack.getCrop()).isNull();
    }
